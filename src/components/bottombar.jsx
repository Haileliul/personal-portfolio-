...
const Footerbar = () => {
  const Contact = Data.Contacts.Social_Media;
  return (
    // <!--Footer container-->
    <footer className="flex flex-col items-center bg-zinc-50 text-center text-surface dark:bg-neutral-700 dark:text-white">
      <div className="container px-6 pt-6">
        ...
        <div className="mb-6 flex justify-center space-x-2">
          ...
          <a
            ...
            target="_blank"
            type="button"
            className="rounded-full bg-[#0088cc] p-3 uppercase leading-normal text-white shadow-dark-3 shadow-black/30 transition duration-150 ease-in-out hover:shadow-dark-1 focus:shadow-dark-1 focus:outline-none focus:ring-0 active:shadow-1 dark:text-white"
            data-twe-ripple-init
            data-twe-ripple-color="light"
          >
            <span className="mx-auto [&>svg]:h-5 [&>svg]:w-5">
              <svg
                ...
                viewBox="0 0 496 512"
              >
                <path d="M248 8C111.2 8 0 119.3 0 256s111.2 248 248 248 248-111.3 248-248S384.8 8 248 8zm113.4 169.1L345 371.7c-2.4 10.6-9.7 13.3-19.6 8.3l-54.3-40.1-26.2 25.2c-2.9 2.9-5.3 5.3-10.8 5.3l3.9-55.2 100.7-90.9c4.4-3.9-.9-6-6.9-2.1L214 296l-52.8-16.5c-10.7-3.3-10.9-10.7 2.3-15.8l206.5-79.3c9.6-3.9 18.1 2.1 15.4 14.8z" />
              </svg>
            </span>
          </a>

          <a
            href={`mailto:${Contact.Gmail}?subject=Your%20Subject&body=Your%20Message`}
            target="_blank"
            type="button"
      ...
      <div className="w-full bg-black/5 p-4 text-center ">
        © 2024 Copyright:
        <a href="https://www.linkedin.com/in/haileliul-baye-b10495234/">
          Haileliul Baye
        </a>
      </div>
    </footer>
