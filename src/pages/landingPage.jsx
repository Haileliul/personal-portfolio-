      ...
      <div className="relative h-full">
        <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-b from-Darker_purple   via-Blue_black  to-Brighter_purple ">
          ...
          <div className="flex flex-col sm:flex-row h-full w-full justify-center items-center ">
            <div className="bg-green-900 w-full sm:w-1/2 h-5/6  flex flex-col items-center justify-center">
              <div className=" w-5/6 lg:py-10 lg:my-10 lg:pl-20 mt-20 mb-10  text-neutral_one">
                ...
                <p className="hidden lg:inline-block font-thin  text-sm my-1">
                  ...
                  full-stack development, and UI/UX design. With a background in
                  AI, I bring a unique perspective to creating innovative and
                  user-centric solutions.
                </p>

                <button
                  className="hover:bg-Darker_purple bg-orange shadow-lg  shadow-deep_green  rounded-lg px-5 py-2 mt-2 text-neutral_tow  text-sm relative z-50"
                  onClick={() => {
            ...
            <div className="relative w-full sm:w-1/2 h-full flex justify-center items-center  ">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-yellow-300 to-yellow-50"></div>
