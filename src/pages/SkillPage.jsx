          ...
          <div key={index}>
            <div className="relative w-full pt-2">
              <div className="flex items-start">
                <span
                  className="absolute bottom-0 mb-7 -translate-x-1/2 w-12 h-10 bg-white shadow-[0px_12px_30px_0px_rgba(16,24,40,0.1)] rounded-full px-3.5 py-2 text-gray-800 text-xs font-medium flex justify-center items-center after:absolute after:bg-white after:flex after:bottom-[-5px] after:left-1/2 after:-z-10 after:h-3 after:w-3 after:-translate-x-1/2 after:rotate-45"
              ...
              <div className="relative flex w-full h-4 overflow-hidden rounded-3xl bg-gray-200">
                <div
                  role="progressbar"
